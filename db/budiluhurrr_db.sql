...
--
-- Database: `budiluhurrr_db`
--

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_action_logs`
--

CREATE TABLE `rpwd0_action_logs` (
...
--
-- Table structure for table `rpwd0_action_logs_extensions`
--

CREATE TABLE `rpwd0_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `rpwd0_action_logs_extensions`
--

INSERT INTO `rpwd0_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Table structure for table `rpwd0_action_logs_users`
--

CREATE TABLE `rpwd0_action_logs_users` (
...
--
-- Table structure for table `rpwd0_action_log_config`
--

CREATE TABLE `rpwd0_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `rpwd0_action_log_config`
--

INSERT INTO `rpwd0_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Table structure for table `rpwd0_assets`
--

CREATE TABLE `rpwd0_assets` (
...
--
-- Dumping data for table `rpwd0_assets`
--

INSERT INTO `rpwd0_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `rpwd0_associations`
--

CREATE TABLE `rpwd0_associations` (
...
--
-- Table structure for table `rpwd0_banners`
--

CREATE TABLE `rpwd0_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `rpwd0_banner_clients`
--

CREATE TABLE `rpwd0_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_banner_tracks`
--

CREATE TABLE `rpwd0_banner_tracks` (
...
--
-- Table structure for table `rpwd0_categories`
--

CREATE TABLE `rpwd0_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `rpwd0_categories`
--

INSERT INTO `rpwd0_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 206, '2023-04-03 05:59:51', 206, '2023-04-03 05:59:51', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_contact_details`
--

CREATE TABLE `rpwd0_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `rpwd0_content`
--

CREATE TABLE `rpwd0_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_contentitem_tag_map`
--

CREATE TABLE `rpwd0_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_content_frontpage`
--

CREATE TABLE `rpwd0_content_frontpage` (
...
--
-- Table structure for table `rpwd0_content_rating`
--

CREATE TABLE `rpwd0_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `rpwd0_content_types`
--

CREATE TABLE `rpwd0_content_types` (
...
--
-- Dumping data for table `rpwd0_content_types`
--

INSERT INTO `rpwd0_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `rpwd0_extensions`
--

CREATE TABLE `rpwd0_extensions` (
...
--
-- Dumping data for table `rpwd0_extensions`
--

INSERT INTO `rpwd0_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
(186, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', NULL, 'system', 0, 1, 1, 0, 1, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"2015-05\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '', '', NULL, NULL, 23, 0, NULL),
...
--
-- Table structure for table `rpwd0_fields`
--

CREATE TABLE `rpwd0_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_fields_categories`
--

CREATE TABLE `rpwd0_fields_categories` (
...
--
-- Table structure for table `rpwd0_fields_groups`
--

CREATE TABLE `rpwd0_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_fields_values`
--

CREATE TABLE `rpwd0_fields_values` (
...
--
-- Table structure for table `rpwd0_finder_filters`
--

CREATE TABLE `rpwd0_finder_filters` (
...
--
-- Table structure for table `rpwd0_finder_links`
--

CREATE TABLE `rpwd0_finder_links` (
...
--
-- Table structure for table `rpwd0_finder_links_terms`
--

CREATE TABLE `rpwd0_finder_links_terms` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_finder_logging`
--

CREATE TABLE `rpwd0_finder_logging` (
...
--
-- Table structure for table `rpwd0_finder_taxonomy`
--

CREATE TABLE `rpwd0_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `rpwd0_finder_taxonomy`
--

INSERT INTO `rpwd0_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_finder_taxonomy_map`
--

CREATE TABLE `rpwd0_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_finder_terms`
--

CREATE TABLE `rpwd0_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_finder_terms_common`
--

CREATE TABLE `rpwd0_finder_terms_common` (
...
--
-- Dumping data for table `rpwd0_finder_terms_common`
--

INSERT INTO `rpwd0_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('about', 'en', 0),
('above', 'en', 0),
('after', 'en', 0),
...
--
-- Table structure for table `rpwd0_finder_tokens`
--

CREATE TABLE `rpwd0_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Table structure for table `rpwd0_finder_tokens_aggregate`
--

CREATE TABLE `rpwd0_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Table structure for table `rpwd0_finder_types`
--

CREATE TABLE `rpwd0_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_history`
--

CREATE TABLE `rpwd0_history` (
...
--
-- Table structure for table `rpwd0_languages`
--

CREATE TABLE `rpwd0_languages` (
...
--
-- Dumping data for table `rpwd0_languages`
--

INSERT INTO `rpwd0_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_mail_templates`
--

CREATE TABLE `rpwd0_mail_templates` (
...
--
-- Dumping data for table `rpwd0_mail_templates`
--

INSERT INTO `rpwd0_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Table structure for table `rpwd0_menu`
--

CREATE TABLE `rpwd0_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `rpwd0_menu`
--

INSERT INTO `rpwd0_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `rpwd0_menu_types`
--

CREATE TABLE `rpwd0_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `rpwd0_menu_types`
--

INSERT INTO `rpwd0_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_messages`
--

CREATE TABLE `rpwd0_messages` (
...
--
-- Table structure for table `rpwd0_messages_cfg`
--

CREATE TABLE `rpwd0_messages_cfg` (
...
--
-- Table structure for table `rpwd0_modules`
--

CREATE TABLE `rpwd0_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `rpwd0_modules`
--

INSERT INTO `rpwd0_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `rpwd0_modules_menu`
--

CREATE TABLE `rpwd0_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `rpwd0_modules_menu`
--

INSERT INTO `rpwd0_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `rpwd0_newsfeeds`
--

CREATE TABLE `rpwd0_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_overrider`
--

CREATE TABLE `rpwd0_overrider` (
...
--
-- Table structure for table `rpwd0_postinstall_messages`
--

CREATE TABLE `rpwd0_postinstall_messages` (
...
--
-- Dumping data for table `rpwd0_postinstall_messages`
--

INSERT INTO `rpwd0_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `rpwd0_privacy_consents`
--

CREATE TABLE `rpwd0_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Table structure for table `rpwd0_privacy_requests`
--

CREATE TABLE `rpwd0_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_redirect_links`
--

CREATE TABLE `rpwd0_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_scheduler_tasks`
--

CREATE TABLE `rpwd0_scheduler_tasks` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_schemas`
--

CREATE TABLE `rpwd0_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `rpwd0_schemas`
--

INSERT INTO `rpwd0_schemas` (`extension_id`, `version_id`) VALUES
(224, '4.2.9-2023-03-07');

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_session`
--

CREATE TABLE `rpwd0_session` (
...
--
-- Dumping data for table `rpwd0_session`
--

INSERT INTO `rpwd0_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x6a3333376470616a3367326e727575707135736a346c64676135, 0, 1, 1680501677, 'joomla|s:620:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_tags`
--

CREATE TABLE `rpwd0_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `rpwd0_tags`
--

INSERT INTO `rpwd0_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 206, '2023-04-03 05:59:47', '', 206, '2023-04-03 05:59:47', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_template_overrides`
--

CREATE TABLE `rpwd0_template_overrides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_template_styles`
--

CREATE TABLE `rpwd0_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `rpwd0_template_styles`
--

INSERT INTO `rpwd0_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Table structure for table `rpwd0_ucm_base`
--

CREATE TABLE `rpwd0_ucm_base` (
...
--
-- Table structure for table `rpwd0_ucm_content`
--

CREATE TABLE `rpwd0_ucm_content` (
...
--
-- Table structure for table `rpwd0_updates`
--

CREATE TABLE `rpwd0_updates` (
...
--
-- Dumping data for table `rpwd0_updates`
--

INSERT INTO `rpwd0_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `changelogurl`, `extra_query`) VALUES
...
--
-- Table structure for table `rpwd0_update_sites`
--

CREATE TABLE `rpwd0_update_sites` (
...
--
-- Dumping data for table `rpwd0_update_sites`
--

INSERT INTO `rpwd0_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 0, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_4.xml', 1, 1680501615, '', NULL, NULL),
(3, 'Joomla! Update Component', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, '', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_update_sites_extensions`
--

CREATE TABLE `rpwd0_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `rpwd0_update_sites_extensions`
--

INSERT INTO `rpwd0_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 224),
(2, 225),
(3, 24);
...
--
-- Table structure for table `rpwd0_usergroups`
--

CREATE TABLE `rpwd0_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `rpwd0_usergroups`
--

INSERT INTO `rpwd0_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `rpwd0_users`
--

CREATE TABLE `rpwd0_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `rpwd0_users`
--

INSERT INTO `rpwd0_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(206, 'marten', 'marten', 'marten110censi@gmail.com', '$2y$10$dkaGjtpCIMz2/Q//dyQKKef20oRYZKLk38uFWI1BOwCgEnIKx6wO.', 0, 1, '2023-04-03 06:00:11', NULL, '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_user_keys`
--

CREATE TABLE `rpwd0_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `rpwd0_user_mfa`
--

CREATE TABLE `rpwd0_user_mfa` (
  `id` int(11) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `rpwd0_user_notes`
--

CREATE TABLE `rpwd0_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Table structure for table `rpwd0_user_profiles`
--

CREATE TABLE `rpwd0_user_profiles` (
...
--
-- Table structure for table `rpwd0_user_usergroup_map`
--

CREATE TABLE `rpwd0_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `rpwd0_user_usergroup_map`
--

INSERT INTO `rpwd0_user_usergroup_map` (`user_id`, `group_id`) VALUES
(206, 8);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_viewlevels`
--

CREATE TABLE `rpwd0_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `rpwd0_viewlevels`
--

INSERT INTO `rpwd0_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `rpwd0_webauthn_credentials`
--

CREATE TABLE `rpwd0_webauthn_credentials` (
...
--
-- Table structure for table `rpwd0_workflows`
--

CREATE TABLE `rpwd0_workflows` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `rpwd0_workflows`
--

INSERT INTO `rpwd0_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2023-04-03 05:59:49', 206, '2023-04-03 05:59:49', 206, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_workflow_associations`
--

CREATE TABLE `rpwd0_workflow_associations` (
...
--
-- Table structure for table `rpwd0_workflow_stages`
--

CREATE TABLE `rpwd0_workflow_stages` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `rpwd0_workflow_stages`
--

INSERT INTO `rpwd0_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rpwd0_workflow_transitions`
--

CREATE TABLE `rpwd0_workflow_transitions` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rpwd0_workflow_transitions`
--

INSERT INTO `rpwd0_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Indexes for table `rpwd0_action_logs`
--
ALTER TABLE `rpwd0_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_action_logs_extensions`
--
ALTER TABLE `rpwd0_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rpwd0_action_logs_users`
--
ALTER TABLE `rpwd0_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indexes for table `rpwd0_action_log_config`
--
ALTER TABLE `rpwd0_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rpwd0_assets`
--
ALTER TABLE `rpwd0_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_associations`
--
ALTER TABLE `rpwd0_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `rpwd0_banners`
--
ALTER TABLE `rpwd0_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_banner_clients`
--
ALTER TABLE `rpwd0_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `rpwd0_banner_tracks`
--
ALTER TABLE `rpwd0_banner_tracks`
...
--
-- Indexes for table `rpwd0_categories`
--
ALTER TABLE `rpwd0_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_contact_details`
--
ALTER TABLE `rpwd0_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `rpwd0_content`
--
ALTER TABLE `rpwd0_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `rpwd0_contentitem_tag_map`
--
ALTER TABLE `rpwd0_contentitem_tag_map`
...
--
-- Indexes for table `rpwd0_content_frontpage`
--
ALTER TABLE `rpwd0_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `rpwd0_content_rating`
--
ALTER TABLE `rpwd0_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `rpwd0_content_types`
--
ALTER TABLE `rpwd0_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `rpwd0_extensions`
--
ALTER TABLE `rpwd0_extensions`
...
--
-- Indexes for table `rpwd0_fields`
--
ALTER TABLE `rpwd0_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `rpwd0_fields_categories`
--
ALTER TABLE `rpwd0_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indexes for table `rpwd0_fields_groups`
--
ALTER TABLE `rpwd0_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `rpwd0_fields_values`
--
ALTER TABLE `rpwd0_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indexes for table `rpwd0_finder_filters`
--
ALTER TABLE `rpwd0_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `rpwd0_finder_links`
--
ALTER TABLE `rpwd0_finder_links`
...
--
-- Indexes for table `rpwd0_finder_links_terms`
--
ALTER TABLE `rpwd0_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `rpwd0_finder_logging`
--
ALTER TABLE `rpwd0_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Indexes for table `rpwd0_finder_taxonomy`
--
ALTER TABLE `rpwd0_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_path` (`path`(100)),
...
--
-- Indexes for table `rpwd0_finder_taxonomy_map`
--
ALTER TABLE `rpwd0_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `rpwd0_finder_terms`
--
ALTER TABLE `rpwd0_finder_terms`
...
--
-- Indexes for table `rpwd0_finder_terms_common`
--
ALTER TABLE `rpwd0_finder_terms_common`
  ADD UNIQUE KEY `idx_term_language` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `rpwd0_finder_tokens`
--
ALTER TABLE `rpwd0_finder_tokens`
...
--
-- Indexes for table `rpwd0_finder_tokens_aggregate`
--
ALTER TABLE `rpwd0_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `rpwd0_finder_types`
--
ALTER TABLE `rpwd0_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `rpwd0_history`
--
ALTER TABLE `rpwd0_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `rpwd0_languages`
--
ALTER TABLE `rpwd0_languages`
...
--
-- Indexes for table `rpwd0_mail_templates`
--
ALTER TABLE `rpwd0_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Indexes for table `rpwd0_menu`
--
ALTER TABLE `rpwd0_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_menu_types`
--
ALTER TABLE `rpwd0_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `rpwd0_messages`
--
ALTER TABLE `rpwd0_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `rpwd0_messages_cfg`
--
ALTER TABLE `rpwd0_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `rpwd0_modules`
--
ALTER TABLE `rpwd0_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_modules_menu`
--
ALTER TABLE `rpwd0_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `rpwd0_newsfeeds`
--
ALTER TABLE `rpwd0_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `rpwd0_overrider`
--
ALTER TABLE `rpwd0_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rpwd0_postinstall_messages`
--
ALTER TABLE `rpwd0_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `rpwd0_privacy_consents`
--
ALTER TABLE `rpwd0_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indexes for table `rpwd0_privacy_requests`
--
ALTER TABLE `rpwd0_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rpwd0_redirect_links`
--
ALTER TABLE `rpwd0_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modified` (`modified_date`);

--
-- Indexes for table `rpwd0_scheduler_tasks`
--
ALTER TABLE `rpwd0_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_schemas`
--
ALTER TABLE `rpwd0_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `rpwd0_session`
--
ALTER TABLE `rpwd0_session`
...
--
-- Indexes for table `rpwd0_tags`
--
ALTER TABLE `rpwd0_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_template_overrides`
--
ALTER TABLE `rpwd0_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Indexes for table `rpwd0_template_styles`
--
ALTER TABLE `rpwd0_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
...
--
-- Indexes for table `rpwd0_ucm_base`
--
ALTER TABLE `rpwd0_ucm_base`
...
--
-- Indexes for table `rpwd0_ucm_content`
--
ALTER TABLE `rpwd0_ucm_content`
...
--
-- Indexes for table `rpwd0_updates`
--
ALTER TABLE `rpwd0_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `rpwd0_update_sites`
--
ALTER TABLE `rpwd0_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `rpwd0_update_sites_extensions`
--
ALTER TABLE `rpwd0_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `rpwd0_usergroups`
--
ALTER TABLE `rpwd0_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_users`
--
ALTER TABLE `rpwd0_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_user_keys`
--
ALTER TABLE `rpwd0_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `rpwd0_user_mfa`
--
ALTER TABLE `rpwd0_user_mfa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indexes for table `rpwd0_user_notes`
--
ALTER TABLE `rpwd0_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `rpwd0_user_profiles`
--
ALTER TABLE `rpwd0_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `rpwd0_user_usergroup_map`
--
ALTER TABLE `rpwd0_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `rpwd0_viewlevels`
--
ALTER TABLE `rpwd0_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indexes for table `rpwd0_webauthn_credentials`
--
ALTER TABLE `rpwd0_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Indexes for table `rpwd0_workflows`
--
ALTER TABLE `rpwd0_workflows`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_workflow_associations`
--
ALTER TABLE `rpwd0_workflow_associations`
...
--
-- Indexes for table `rpwd0_workflow_stages`
--
ALTER TABLE `rpwd0_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `rpwd0_workflow_transitions`
--
ALTER TABLE `rpwd0_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT for table `rpwd0_action_logs`
--
ALTER TABLE `rpwd0_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_action_logs_extensions`
--
ALTER TABLE `rpwd0_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `rpwd0_action_log_config`
--
ALTER TABLE `rpwd0_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `rpwd0_assets`
--
ALTER TABLE `rpwd0_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT for table `rpwd0_banners`
--
ALTER TABLE `rpwd0_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_banner_clients`
--
ALTER TABLE `rpwd0_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_categories`
--
ALTER TABLE `rpwd0_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `rpwd0_contact_details`
--
ALTER TABLE `rpwd0_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_content`
--
ALTER TABLE `rpwd0_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_content_types`
--
ALTER TABLE `rpwd0_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT for table `rpwd0_extensions`
--
ALTER TABLE `rpwd0_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;

--
-- AUTO_INCREMENT for table `rpwd0_fields`
--
ALTER TABLE `rpwd0_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_fields_groups`
--
ALTER TABLE `rpwd0_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_finder_filters`
--
ALTER TABLE `rpwd0_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_finder_links`
--
ALTER TABLE `rpwd0_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_finder_taxonomy`
--
ALTER TABLE `rpwd0_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_finder_terms`
--
ALTER TABLE `rpwd0_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_finder_types`
--
ALTER TABLE `rpwd0_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_history`
--
ALTER TABLE `rpwd0_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_languages`
--
ALTER TABLE `rpwd0_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_menu`
--
ALTER TABLE `rpwd0_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `rpwd0_menu_types`
--
ALTER TABLE `rpwd0_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_messages`
--
ALTER TABLE `rpwd0_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_modules`
--
ALTER TABLE `rpwd0_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT for table `rpwd0_newsfeeds`
--
ALTER TABLE `rpwd0_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_overrider`
--
ALTER TABLE `rpwd0_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT for table `rpwd0_postinstall_messages`
--
ALTER TABLE `rpwd0_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `rpwd0_privacy_consents`
--
ALTER TABLE `rpwd0_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_privacy_requests`
--
ALTER TABLE `rpwd0_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_redirect_links`
--
ALTER TABLE `rpwd0_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_scheduler_tasks`
--
ALTER TABLE `rpwd0_scheduler_tasks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_tags`
--
ALTER TABLE `rpwd0_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_template_overrides`
--
ALTER TABLE `rpwd0_template_overrides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_template_styles`
--
ALTER TABLE `rpwd0_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `rpwd0_ucm_content`
--
ALTER TABLE `rpwd0_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_updates`
--
ALTER TABLE `rpwd0_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `rpwd0_update_sites`
--
ALTER TABLE `rpwd0_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `rpwd0_usergroups`
--
ALTER TABLE `rpwd0_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rpwd0_users`
--
ALTER TABLE `rpwd0_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;

--
-- AUTO_INCREMENT for table `rpwd0_user_keys`
--
ALTER TABLE `rpwd0_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_user_mfa`
--
ALTER TABLE `rpwd0_user_mfa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_user_notes`
--
ALTER TABLE `rpwd0_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rpwd0_viewlevels`
--
ALTER TABLE `rpwd0_viewlevels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `rpwd0_workflows`
--
ALTER TABLE `rpwd0_workflows`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_workflow_stages`
--
ALTER TABLE `rpwd0_workflow_stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `rpwd0_workflow_transitions`
--
ALTER TABLE `rpwd0_workflow_transitions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
